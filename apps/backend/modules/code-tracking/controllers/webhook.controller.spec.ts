...
describe('WebhookController', () => {
  ...
  describe('handleGitHubWebhook', () => {
    ...
    it('should handle push events successfully', async () => {
      ...
      expect(mockWebhookService.handlePushEvent).toHaveBeenCalledWith(
        mockPayload,
      );
    ...
    it('should handle service errors gracefully', async () => {
      mockConfigService.get.mockReturnValue('webhook-secret');
      mockWebhookService.validateWebhookSignature.mockReturnValue(true);
      mockWebhookService.handlePushEvent.mockRejectedValue(
    ...
    it('should handle pull request events successfully', async () => {
      ...
      expect(mockWebhookService.handlePullRequestEvent).toHaveBeenCalledWith(
        prPayload,
      );
  ...
  describe('processPendingEvents', () => {
    ...
    it('should handle processing errors', async () => {
      mockWebhookService.processPendingEvents.mockRejectedValue(
        new Error('Processing failed'),
      );

      await expect(controller.processPendingEvents()).rejects.toThrow(
        'Processing failed',
      );
    });
  });
